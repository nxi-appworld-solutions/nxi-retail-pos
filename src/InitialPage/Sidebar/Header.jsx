...
const Header = () => {
  ...
  const [flagImage, setFlagImage] = useState("assets/img/flags/in.png");
        ...
        <div className="main-header">
          ...
          <ul className="nav user-menu">
            ...
            <li className="nav-item dropdown has-arrow main-drop profile-nav">
              ...
              <div className="dropdown-menu menu-drop-user">
                ...
                <hr className="my-2" />
                <Link className="dropdown-item logout pb-0" to={route.signin} onClick={() => { sessionStorage.removeItem("token"); sessionStorage.removeItem("refreshToken"); }}>
          ...
          <div className="dropdown mobile-user-menu">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <Link className="dropdown-item" to="signin" onClick={() => { localStorage.removeItem("token"); localStorage.removeItem("refreshToken"); }}>
                Logout
              </Link>
            </div>
          </div>
