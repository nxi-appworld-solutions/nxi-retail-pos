...
import {
  selectStoreType,
  setStoreType,
} from "../../../core/redux/storeTypeSlice";
      ...
      <div className="header pos-header">
        ...
        <div className="header-left active">
          <Link to={all_routes.newdashboard} className="logo logo-normal">
            <ImageWithBasePath src={logoPng} alt="Img" />
          </Link>
          <Link to={all_routes.newdashboard} className="logo logo-white">
            <ImageWithBasePath src={logoWhitePng} alt="Img" />
          </Link>
          <Link to={all_routes.newdashboard} className="logo-small">
            <ImageWithBasePath src={logoSmallPng} alt="Img" />
          </Link>
        </div>
        {/* /Logo */}
              ...
              <div className="profilename">
                <div className="profileset">
                  <span className="user-img">
                    <ImageWithBasePath src={avatar01} alt="Img" />
