...
import ProductERPLayout from "../components/ProductERPLayout";
  ...
  return (
    <form onSubmit={onSubmit}>
      <div className="page-wrapper">
        ...
        <div className="fixed-bottom bg-white border-top p-3 shadow-lg d-flex justify-content-end gap-3 px-5" style={{ zIndex: 1000 }}>
          ...
          <button type="submit" className="btn btn-primary px-5 fw-bold d-flex align-items-center shadow">
            <Save size={16} className="me-2" /> Save Product
          </button>
        </div>
      </div>
